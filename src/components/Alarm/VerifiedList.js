...
@connect(({ verified }) => ({ getmoreverified:verified.getmoreverified,fetching:verified.fetching,verifiedlist:verified.verifiedlist,fetchtime:verified.fetchtime}))
  ...
  _renderItem = ({item}) =>{
    ...
    return (
      <TouchableOpacity onPress={()=>{
        this.props.dispatch(createAction('feedback/getfeedbackdetail')({
          verifyID:item.ID
        }));
