...
class QRScannerRectView extends Component {
    ...
    constructor(props) {
        ...
        this.getBackgroundColor = this
            .getBackgroundColor
            .bind(this);
        this.getRectSize = this
            .getRectSize
            .bind(this);
        this.getCornerSize = this
            .getCornerSize
            .bind(this);
        this.renderLoadingIndicator = this
    ...
    getBottomMenuHeight() {
        return ({bottom: this.props.bottomMenuHeight});
    }
    ...
    render() {
        ...
        return (
            <View
                ...
                style={[
                styles.container, this.getBottomMenuHeight()
            ]}>
            ...
            <View style={{
                ...
                <Camera
                    ...
                    <QRScannerRectView
                        ...
                        isShowScanBar={this.props.isShowScanBar}/> {/*绘制底部操作栏*/}
