...
export default {
  ...
  effects: {
      *loadverifiedlist({ payload: {isfirst,time} }, { call, put ,select}){
        ...
        result = yield call(AlarmService.loadaverifiedlist,{time:time})
        ...
        yield put(createAction('fetchEnd')({ verifiedlist:oldCollection,fetchtime:newtime,getmoreverified:getmoreverified}))
      }
  },
}
