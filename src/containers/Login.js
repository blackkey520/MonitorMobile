...
@connect(({ app }) => ({ ismaintenance: app.ismaintenance, fetching: app.fetching, globalConfig: app.globalConfig }))
class Login extends PureComponent {
  ...
  async componentWillMount() {
    ...
    if (user) {
      ...
      this.props.dispatch(createAction('app/loadglobalvariable')({}));
    } else {
      SplashScreen.hide();
    }
  }
